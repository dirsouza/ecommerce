...
<html>
    <head>
        ...
        -->
        <link rel="stylesheet" href="../../src/admin/dist/css/skins/skin-green.min.css">
    ...
    |---------------------------------------------------------|
    -->
    <body class="hold-transition skin-green layout-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="/admin" class="logo">
                    ...
                    <span class="logo-mini"><b>E-</b>Adm</span>
