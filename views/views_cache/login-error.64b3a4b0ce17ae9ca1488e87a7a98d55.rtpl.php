...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="../../src/admin/plugins/iCheck/square/green.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-logo">
                <a href="/admin/login"><b>E-Commerce</b>Login</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <form action="/admin/login" method="post">
                    <div class="form-group has-feedback">
                        <input type="text" name="login" class="form-control" autofocus placeholder="Login">
                ...
                <a href="#">Registrar-me</a><br><br>
                <a href="/">
                    <button type="button" class="btn btn-primary btn-block btn-flat">Retornar para Loja</button>
                </a>
