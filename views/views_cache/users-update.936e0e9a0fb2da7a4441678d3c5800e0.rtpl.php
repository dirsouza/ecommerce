                    ...
                    <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="desperson" name="desperson" autofocus placeholder="Digite o nome" value="<?php echo htmlspecialchars( $user["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                        </div>
                        <div class="form-group">
